...
# ===== 모델 및 라벨 로딩 =====
MODEL_PATH = r"C:\SoftwareEdu2025\project\Hand_Sound\KCH\signtotext\models\mydata_test\gesture_model.h5"   # ⭐️ 학습 모델 경로
LABEL_PATH = r"C:\SoftwareEdu2025\project\Hand_Sound\KCH\signtotext\models\mydata_test\label_map.json"      # ⭐️ 라벨 경로
...
BUFFER_SIZE = 20   # ⭐️ train 프레임 수와 일치
